...
namespace Raneen.Services
{
    internal class Product
    {
        ...
        public static async Task<IEnumerable<ProductModel>> getAllUsers()
        {
        ...
        public static async Task<ProductModel> getUser(int id)
        {
        ...
        public static async Task AddUser(int _id, double _price, double _oldPrice,
        ...
        public static async Task UpdateUser(ProductModel product)
        {
            database = await Database.Init(database);
